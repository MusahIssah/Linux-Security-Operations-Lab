...
- [x] [Part 4: Credentialed Vulnerability Scanning and Remediation](04-vulnerability-management/) — Completed. Scanned the RHEL VM with Nessus Essentials, blocked ICMP timestamp requests with firewalld, and verified the targeted finding cleared on a credentialed rescan.
